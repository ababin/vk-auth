...
public final class VkApi {
    ...
    private void auth(String appId) throws IOException {
        ...
        System.out.println("For access_token please visit this page: " + reqUrl);
    	System.exit(0);
    }
    ...
    public String find(String criteria, int count) throws IOException {
    ...
    public String getInfoByUserIds(String ids, String fields) throws IOException {
